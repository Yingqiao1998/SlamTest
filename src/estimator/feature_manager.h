...
public:
  ...
  FeaturePerId(int _feature_id, int _start_frame)
      : feature_id(_feature_id), start_frame(_start_frame), used_num(0), estimated_depth(-1.0),
        solve_flag(0) {}
...
public:
  ...
  int getFeatureCount();
  bool
  addFeatureCheckParallax(int frame_count,
  ...
  // 添加获取特征点的公有接口
  const list<FeaturePerId> &getFeatureList() const { return feature; }
