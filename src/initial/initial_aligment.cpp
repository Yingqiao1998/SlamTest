...
void solveGyroscopeBias(map<double, ImageFrame> &all_image_frame, Vector3d *Bgs) {
  ...
  RCLCPP_WARN_STREAM(rclcpp::get_logger("initial_alignment"),
                     "gyroscope bias initial calibration " << delta_bg.transpose());
...
bool LinearAlignment(map<double, ImageFrame> &all_image_frame, Vector3d &g, VectorXd &x) {
  ...
  RCLCPP_DEBUG(rclcpp::get_logger("initial_alignment"), "estimated scale: %f", s);
  g = x.segment<3>(n_state - 4);
  RCLCPP_DEBUG_STREAM(rclcpp::get_logger("initial_alignment"),
